...
var app = (function () {
    ...
    // (26:20) <Link aria-current="{currentPage === link.href}" to="{link.href}">
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*links*/ 1 && t_value !== (t_value = /*link*/ ctx[2].name + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:20) <Link aria-current=\\\"{currentPage === link.href}\\\" to=\\\"{link.href}\\\">",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	link = new Link({
    			props: {
    				"aria-current": /*currentPage*/ ctx[1] === /*link*/ ctx[2].href,
    				to: /*link*/ ctx[2].href,
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li, "class", "svelte-1kcv9fg");
    			add_location(li, file$5, 25, 16, 513);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			const link_changes = {};
    			if (dirty & /*currentPage, links*/ 3) link_changes["aria-current"] = /*currentPage*/ ctx[1] === /*link*/ ctx[2].href;
    			if (dirty & /*links*/ 1) link_changes.to = /*link*/ ctx[2].href;

    			if (dirty & /*$$scope, links*/ 33) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:12) {#each links as link}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "/assets/logo2.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Artur Basak. Art Gallery");
    			attr_dev(img, "class", "svelte-1kcv9fg");
    			add_location(img, file$5, 21, 4, 379);
    			attr_dev(ul, "class", "svelte-1kcv9fg");
    			add_location(ul, file$5, 23, 8, 458);
    			attr_dev(nav, "class", "svelte-1kcv9fg");
    			add_location(nav, file$5, 22, 4, 444);
    			attr_dev(header, "class", "svelte-1kcv9fg");
    			add_location(header, file$5, 20, 0, 366);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link, links, currentPage });
    	...
    	$$invalidate(1, currentPage = window.location.pathname);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-18vk0dr");
    			add_location(img, file$3, 9, 20, 267);
    			attr_dev(picture, "class", "svelte-18vk0dr");
    			add_location(picture, file$3, 8, 16, 237);
    			attr_dev(a, "class", "thing svelte-18vk0dr");
    			...
    			add_location(span, file$3, 12, 24, 416);
    			attr_dev(figcaption, "class", "svelte-18vk0dr");
    			add_location(figcaption, file$3, 12, 12, 404);
    			attr_dev(figure, "class", "svelte-18vk0dr");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "gallery svelte-18vk0dr");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br0 = element("br");
    			a0 = element("a");
    			a0.textContent = "artur.basak.devingrodno@gmail.com";
    			t2 = space();
    			div1 = element("div");
    			b1 = element("b");
    			b1.textContent = "Instagram:";
    			br1 = element("br");
    			a1 = element("a");
    			a1.textContent = "@belarusian_monsters";
    			t5 = space();
    			div2 = element("div");
    			b2 = element("b");
    			b2.textContent = "Facebook:";
    			br2 = element("br");
    			a2 = element("a");
    			a2.textContent = "artur.basak";
    			t8 = space();
    			div3 = element("div");
    			b3 = element("b");
    			...
    			br3 = element("br");
    			a3 = element("a");
    			a3.textContent = "arturbasak";
    			add_location(b0, file$2, 3, 9, 38);
    			add_location(br0, file$2, 3, 22, 51);
    			attr_dev(a0, "href", "mailto:artur.basak.devingrodno@gmail.com");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$2, 3, 26, 55);
    			attr_dev(div0, "class", "svelte-1i5eh52");
    			add_location(div0, file$2, 3, 4, 33);
    			add_location(b1, file$2, 4, 9, 175);
    			add_location(br1, file$2, 4, 26, 192);
    			attr_dev(a1, "href", "https://www.instagram.com/belarusian_monsters/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noreferrer noopener external");
    			add_location(a1, file$2, 4, 30, 196);
    			attr_dev(div1, "class", "svelte-1i5eh52");
    			add_location(div1, file$2, 4, 4, 170);
    			add_location(b2, file$2, 5, 9, 344);
    			add_location(br2, file$2, 5, 25, 360);
    			attr_dev(a2, "href", "https://www.facebook.com/artur.basak/");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noreferrer noopener external");
    			add_location(a2, file$2, 5, 29, 364);
    			attr_dev(div2, "class", "svelte-1i5eh52");
    			add_location(div2, file$2, 5, 4, 339);
    			add_location(b3, file$2, 6, 9, 494);
    			add_location(br3, file$2, 6, 25, 510);
    			attr_dev(a3, "href", "https://www.linkedin.com/in/arturbasak/");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "rel", "noreferrer noopener external");
    			add_location(a3, file$2, 6, 29, 514);
    			attr_dev(div3, "class", "svelte-1i5eh52");
    			add_location(div3, file$2, 6, 4, 489);
    			attr_dev(address, "class", "svelte-1i5eh52");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p0 = element("p");
    			p0.textContent = "Artur Basak is a self-taught graphic artist from Grodno, Belarus. By profession a programmer, UI engineer, but in his spare time draws.\n        He was born in Baranovichi later moved to Grodno.\n        The author takes the main subjects of his drawings from Belarusian folklore, famous legends and myths.\n        All works of the author are painted in digital format using the Samsung Note 10 and S Pen.";
    			t1 = space();
    			hr = element("hr");
    			t2 = space();
    			p1 = element("p");
    			p1.textContent = "Артур Басак — мастак-самавук, графік з Гродна, краіна Беларусь. Па прафесіі праграміст, інжынер карыстацкіх інтэрфейсаў, але ў свабодны час малюе.\n        Нарадзіўся ў горадзе Баранавічы, пасля пераехаў у Гродна.\n        Асноўныя сюжэты сваіх малюнкаў аўтар бярэ з беларускага фальклору, вядомых легенд і міфаў.\n        Усе працы аўтара выкананы ў лічбавым фармаце з выкарыстаннем Samsung Note 10 і S Pen.";
    			add_location(p0, file$1, 1, 4, 14);
    			attr_dev(hr, "class", "svelte-yblwjn");
    			add_location(hr, file$1, 5, 4, 429);
    			attr_dev(p1, "lang", "be");
    			add_location(p1, file$1, 6, 4, 440);
    			attr_dev(article, "class", "svelte-yblwjn");
    ...
    const data = [
      ...
      {
        imgUrl: "/liasun.png",
        title: "Лясун, Лесавік, Лешы, Лясны дзед",
        title_eng: "Forest goblin",
      },
      {
        imgUrl: "/kikimora.png",
        title: "Кікімара",
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:2) <Route path=\\\"/contacts\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 11, 1, 377);
    		},
    		m: function mount(target, anchor) {
