...
var app = (function () {
    ...
    const data = [
      ...
      },
      {
        imgUrl: "/zdan.png",
        title: "Здань, Прывід",
        title_eng: "Zdan, Ghost, Spirit",
      },
      {
        imgUrl: "/spider.png",
        title: "Саламяны Павук",
        title_eng: "Himmel",
      },
      {
        imgUrl: "/vargin.jpg",
        title: "Варгін, Кашачы Кароль",
        title_eng: "Vargin, Cat King",
      },
      {
        imgUrl: "/switezianka.png",
        title: "Свіцязянка",
        title_eng: "Svityazyanka, The Nixie, The Nymph of Lake Svityaz",
      },
      {
        imgUrl: "/natrix-king.png",
        title: "Вужыны Кароль",
        title_eng: "Natrix King",
      },
      {
      ...
      {
        imgUrl: "/vampire.png",
        title: "Вупыр, Вурдалак",
        title_eng: "Vampire, Ghoul",
      },
      {
      ...
      {
        imgUrl: "/kupalski-dedok.png",
        title: "Купальскі Дзядок",
        title_eng: "Kupala's Grandfather, Spirit of Kupala Night",
      },
      {
        imgUrl: "/eunik.jpg",
        title: "Ёўнік, Асетнік",
      ...
      {
        imgUrl: "/lukoml-dragon.png",
        title: "Лукомскі цмок",
        title_eng: "Lukoml dragon",
      },
      {
        imgUrl: "/hapun.jpg",
        title: "Хапун",
      ...
      },
      {
        imgUrl: "/vuzhalka.png",
        title: "Вужалка",
        title_eng: "Vuzhalka, Snake woman",
      },
      {
        imgUrl: "/kuk.jpg",
        title: "Кук, Кароль Птушак",
        title_eng: "Kuk, Birds King",
      },
      {
        imgUrl: "/chargavy.png",
        title: "Чаргавы, Магільны Стораж",
        title_eng: "Chargavy, Grave Guard",
      },
      {
        imgUrl: "/dzikae-palavannie.png",
      ...
      {
        imgUrl: "/bai-stavry-gavry.png",
        title: "Беларускі князь Бай і яго псы Стаўры і Гаўры",
        title_eng: "Belarusian prince Bai and his dogs Stavry and Havry",
      },
      {
        imgUrl: "/sheshik.png",
        title: "Шэшка",
